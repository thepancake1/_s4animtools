...
class ExportRig(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        all_data = io.BytesIO()
        _s4animtools.clip_processing.test_tool.recursive_write([*serialized_rig.serialize()], all_data)
...
class SyncRigToMesh(bpy.types.Operator):
    ...
    def execute(self, context):
        ...
        for group in bpy.data.objects["Cube"].vertex_groups:
            ...
            hashed_name = _s4animtools.clip_processing.test_tool.get_hash_from_bone_name(group_name)
            for bone in bones:
        ...
        all_data = io.BytesIO()
        _s4animtools.clip_processing.test_tool.recursive_write([*rcol.serialize()], all_data)
